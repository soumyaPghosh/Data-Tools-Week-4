...
## Application
 ...
 - The second half of the mentioned assignment was to develop a web application. The application was named ***MPG Prediction***. An instance is up & running at <https://soumyapghosh-tutorial.shinyapps.io/dt_week4/>.
 ...
 - The application and the current presentation source codes can be found at <https://github.com/soumyaPghosh/Data-Tools-Week-4>. The application comprises 3 files: *ui.R* (UI), *server.R* (backend) and *modelBuilding.R* (Random Forest predictor).
